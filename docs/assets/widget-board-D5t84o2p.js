import{p,D as $,r as h,v as i,G as C,j as d,c as w,n as E,h as k,b as W,P as G,l as L,m as K,d as J,z as R,k as Q}from"./source-panel-cwX9nwkb.js";import{C as Z}from"./widgets-Bo9jPsTR.js";import{w as nn}from"./widgets-L_2qlmzG.js";const en=`// ============================================================================
...
`,g=184,y=92;function m(n){const e=Math.min(n.w,n.h);return h(n.center.x-e/2,n.center.y-e/2,e,e)}const v=(n,e)=>({muted:n.muted,accent:n.accent,bright:n.textBright,dim:n.textDim,well:w(n.bg,.5),thumb:n.mix(n.textBright,n.accent,.3*(e.hover||0)),glow:9*(e.hover||0)});function tn(n,e,t,r,c){const o=e.center.y;n.box(h(e.x,o-2.5,e.w,5),2.5,r),t>0&&n.box(h(e.x,o-2.5,e.w*d(t,0,1),5),2.5,c)}function f(n,e,t,r,c,o){n.glow(c,r,()=>n.dot(e,t,o))}const D=Math.PI*2,X=n=>(n*180/Math.PI+360)%360;function rn(n,e){switch(e.kind){case"scalar":return{...n,scalar:e.value};case"range":return{...n,range:e.value};case"scrub":return{...n,scrub:e.value};case"ease":return{...n,ease:e.value};case"angle":return{...n,angle:e.value};case"arc":return{...n,arc:e.value};case"xy":return{...n,xy:e.value};case"box":return{...n,box:e.value};case"cube":return{...n,cube:e.value};case"color":return{...n,color:e.value};case"gradient":return{...n,gradient:e.value};case"toggle":return{...n,toggle:!n.toggle};case"check":return{...n,check:!n.check};case"segment":return{...n,segment:e.value};case"vec3":return{...n,vec3:e.value}}}const cn=p()("w-slider",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.rect,c=h(r.x+8,r.center.y-10,r.w-16,20);tn(e,c,n.props.value,t.muted,t.accent),f(e,i(c.x+c.w*n.props.value,c.center.y),7+1.5*n.ch.hover,t.glow,t.accent,t.thumb)},on:[$({axis:"x",pad:8,to:(n,e)=>({kind:"scalar",value:e})})]}),on=p()("w-range",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.props,c=n.rect,o=h(c.x+8,c.y,c.w-16,c.h),a=o.center.y;e.box(h(o.x,a-2.5,o.w,5),2.5,t.muted);const s=o.x+o.w*r.min,l=o.x+o.w*r.max;e.box(h(s,a-2.5,l-s,5),2.5,t.accent),f(e,i(s,a),7,t.glow,t.accent,t.thumb),f(e,i(l,a),7,t.glow,t.accent,t.thumb)},on:[C({begin(n,e){const t=h(n.rect.x+8,n.rect.y,n.rect.w-16,n.rect.h),r=d((e.x-t.x)/t.w,0,1);return{which:Math.abs(r-n.props.min)<=Math.abs(r-n.props.max)?"min":"max"}},during(n,e,t){const r=h(e.rect.x+8,e.rect.y,e.rect.w-16,e.rect.h),c=d((t.x-r.x)/r.w,0,1),{min:o,max:a}=e.props;return{kind:"range",value:n.which==="min"?{min:Math.min(c,a),max:a}:{min:o,max:Math.max(c,o)}}}})]}),an=p()("w-scrub",{size:()=>i(g,y),style:(n,e)=>({...v(n,e),text:n.mix(n.text,n.textBright,e.hover||0)}),render:(n,e,t)=>{const r=n.rect;e.label(n.props.value.toFixed(1),r.center,t.text,{size:26,weight:700}),e.label("‹ drag horizontally ›",i(r.center.x,r.bottom-6),w(t.dim,.8),{size:10})},on:[C({begin:(n,e)=>({start:n.props.value,startX:e.x}),during:(n,e,t)=>({kind:"scrub",value:n.start+(t.x-n.startX)*.5})})]});function sn(n,e){const t=1-e,r=3*t*t*e,c=3*t*e*e,o=e*e*e;return i(r*n.x1+c*n.x2+o,r*n.y1+c*n.y2+o)}const ln=p()("w-bezier",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.props,c=m(n.rect),o=u=>i(c.x+u.x*c.w,c.bottom-u.y*c.h);e.box(c,6,t.well,t.muted,1),e.line(i(c.x,c.bottom),i(c.right,c.y),w(t.muted,.6));let a=o(i(0,0));for(let u=1;u<=24;u++){const x=o(sn(r,u/24));e.line(a,x,t.accent,2),a=x}const s=o(i(r.x1,r.y1)),l=o(i(r.x2,r.y2));e.line(o(i(0,0)),s,w(t.dim,.8),1),e.line(o(i(1,1)),l,w(t.dim,.8),1),f(e,s,5+n.ch.hover,t.glow,t.accent,t.thumb),f(e,l,5+n.ch.hover,t.glow,t.accent,t.thumb)},on:[C({begin(n,e){const t=m(n.rect),r=(s,l)=>i(t.x+s*t.w,t.bottom-l*t.h),c=n.props,o=E(e,r(c.x1,c.y1)),a=E(e,r(c.x2,c.y2));return{which:o<=a?"1":"2"}},during(n,e,t){const r=m(e.rect),c=d((t.x-r.x)/r.w,0,1),o=d((r.bottom-t.y)/r.h,0,1),a=e.props;return{kind:"ease",value:n.which==="1"?{...a,x1:c,y1:o}:{...a,x2:c,y2:o}}}})]}),un=p()("w-angle",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=m(n.rect),c=r.center,o=r.w/2-6;e.ring(c,o,t.muted,2);const a=n.props.angle*Math.PI/180,s=i(c.x+Math.cos(a)*o,c.y+Math.sin(a)*o);e.line(c,s,t.accent,2.5),f(e,s,5+n.ch.hover*2,t.glow,t.accent,t.thumb),e.dot(c,3,t.dim)},on:[C({begin:()=>({}),during(n,e,t){const r=m(e.rect).center;return{kind:"angle",value:X(Math.atan2(t.y-r.y,t.x-r.x))}}})]});function dn(n,e,t,r,c,o){const a=(c-r+360)%360||360,s=Math.max(2,Math.round(a/8));for(let l=0;l<=s;l++){const u=(r+a*l/s)*Math.PI/180;n.dot(i(e.x+Math.cos(u)*t,e.y+Math.sin(u)*t),2,o)}}const hn=p()("w-arc",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.props,c=m(n.rect),o=c.center,a=c.w/2-6;e.ring(o,a,t.muted,1.5),dn(e,o,a,r.start,r.end,t.accent);for(const s of[r.start,r.end]){const l=s*Math.PI/180;f(e,i(o.x+Math.cos(l)*a,o.y+Math.sin(l)*a),5+n.ch.hover*2,t.glow,t.accent,t.thumb)}},on:[C({begin(n,e){const t=m(n.rect).center,r=X(Math.atan2(e.y-t.y,e.x-t.x)),c=o=>Math.min((r-o+360)%360,(o-r+360)%360);return{which:c(n.props.start)<=c(n.props.end)?"start":"end"}},during(n,e,t){const r=m(e.rect).center,c=X(Math.atan2(t.y-r.y,t.x-r.x));return{kind:"arc",value:{...e.props,[n.which]:c}}}})]}),xn=p()("w-xy",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.props,c=m(n.rect);e.box(c,6,t.well,t.muted,1),e.line(i(c.x,c.center.y),i(c.right,c.center.y),w(t.muted,.6)),e.line(i(c.center.x,c.y),i(c.center.x,c.bottom),w(t.muted,.6));const o=i(c.center.x+r.x*c.w/2,c.center.y-r.y*c.h/2);f(e,o,6+n.ch.hover*2,t.glow,t.accent,t.thumb)},on:[C({begin:()=>({}),during(n,e,t){const r=m(e.rect);return{kind:"xy",value:{x:d((t.x-r.center.x)/(r.w/2),-1,1),y:d(-(t.y-r.center.y)/(r.h/2),-1,1)}}}})]}),mn=p()("w-box2d",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.props,c=m(n.rect);e.box(c,6,t.well,t.muted,1);const o=(l,u)=>i(c.x+l*c.w,c.bottom-u*c.h),a=o(r.minX,r.minY),s=o(r.maxX,r.maxY);e.box(h(Math.min(a.x,s.x),Math.min(a.y,s.y),Math.abs(s.x-a.x),Math.abs(s.y-a.y)),3,w(t.accent,.2),t.accent,1.5),f(e,a,5+n.ch.hover,t.glow,t.accent,t.thumb),f(e,s,5+n.ch.hover,t.glow,t.accent,t.thumb)},on:[C({begin(n,e){const t=m(n.rect),r=n.props,c=(s,l)=>i(t.x+s*t.w,t.bottom-l*t.h),o=E(e,c(r.minX,r.minY)),a=E(e,c(r.maxX,r.maxY));return{corner:o<=a?"min":"max"}},during(n,e,t){const r=m(e.rect),c=d((t.x-r.x)/r.w,0,1),o=d((r.bottom-t.y)/r.h,0,1),a=e.props,s=n.corner==="min"?{...a,minX:Math.min(c,a.maxX),minY:Math.min(o,a.maxY)}:{...a,maxX:Math.max(c,a.minX),maxY:Math.max(o,a.minY)};return{kind:"box",value:{minX:s.minX,minY:s.minY,maxX:s.maxX,maxY:s.maxY}}}})]}),T=[];for(let n=0;n<8;n++)T.push([n&1?1:-1,n&2?1:-1,n&4?1:-1]);const H=[];for(let n=0;n<8;n++)for(let e=n+1;e<8;e++){const t=n^e;(t===1||t===2||t===4)&&H.push([n,e])}const pn=p()("w-box3d",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const{yaw:r,pitch:c}=n.props,o=m(n.rect),a=o.center,s=o.w/2-8,l=Math.cos(r),u=Math.sin(r),x=Math.cos(c),M=Math.sin(c),N=([q,S,P])=>{const U=q*l+P*u,B=-q*u+P*l,j=S*x-B*M,_=1/(1+(S*M+B*x)*.18);return i(a.x+U*s*_,a.y+j*s*_)},A=T.map(N);for(const[q,S]of H)e.line(A[q],A[S],w(t.accent,.85),1.5);for(const q of A)e.dot(q,2.5,t.bright)},on:[C({begin:(n,e)=>({yaw:n.props.yaw,pitch:n.props.pitch,x:e.x,y:e.y}),during:(n,e,t)=>({kind:"cube",value:{yaw:n.yaw+(t.x-n.x)*.012,pitch:d(n.pitch+(t.y-n.y)*.012,-1.3,1.3)}})})]}),bn=p()("w-color",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const{hue:r,sat:c}=n.props,o=m(n.rect),a=o.center,s=o.w/2-4;for(let x=0;x<72;x++){const M=x/72*D;e.dot(i(a.x+Math.cos(M)*s,a.y+Math.sin(M)*s),3,k(x/72*360,.7,.55))}e.dot(a,s-8,k(r*360,c,.55));const l=r*D,u=c*(s-8);f(e,i(a.x+Math.cos(l)*u,a.y+Math.sin(l)*u),5+n.ch.hover*2,t.glow,t.accent,t.thumb)},on:[C({begin:()=>({}),during(n,e,t){const r=m(e.rect),c=r.center,o=r.w/2-12,a=t.x-c.x,s=t.y-c.y;return{kind:"color",value:{hue:(Math.atan2(s,a)/D%1+1)%1,sat:d(Math.hypot(a,s)/o,0,1)}}}})]}),V=k(205,.75,.55),O=k(330,.75,.58),gn=p()("w-gradient",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.props.at,c=n.rect,o=h(c.x+8,c.center.y-14,c.w-16,28),a=48;for(let l=0;l<a;l++)e.box(h(o.x+o.w*l/a,o.y,o.w/a+1,o.h),0,W(V,O,l/a));const s=o.x+o.w*r;e.box(h(s-2,o.y-4,4,o.h+8),1,t.bright),f(e,i(s,o.bottom+8),5+n.ch.hover,t.glow,t.accent,t.thumb)},on:[$({axis:"x",pad:8,to:(n,e)=>({kind:"gradient",value:e})})]}),yn=p()("w-toggle",{size:()=>i(g,y),channels:{on:{target:n=>n.props.on?1:0,spring:{stiffness:260,damping:20}}},style:(n,e)=>({...v(n,e),track:n.mix(n.muted,n.accent,d(e.on||0,0,1))}),render:(n,e,t)=>{const r=n.rect,c=d(n.ch.on,0,1),o=h(r.center.x-26,r.center.y-13,52,26);e.box(o,13,t.track),e.glow(t.accent,8*n.ch.hover,()=>e.dot(i(o.x+13+c*26,o.center.y),9,t.bright))},on:[G(()=>({kind:"toggle"}))]}),vn=p()("w-check",{size:()=>i(g,y),channels:{on:{target:n=>n.props.on?1:0,spring:{stiffness:340,damping:22}}},style:(n,e)=>{const t=d(e.on||0,0,1);return{...v(n,e),fill:n.mix(n.surface,n.accent,t*.9),edge:n.mix(n.muted,n.accent,Math.max(t,e.hover||0))}},render:(n,e,t)=>{const r=n.rect,c=d(n.ch.on,0,1),o=h(r.center.x-15,r.center.y-15,30,30);if(e.box(o,7,t.fill,t.edge,1.5),c>.02){const a=o.center,s=Math.min(1.1,c);e.line(i(a.x-6*s,a.y),i(a.x-1.5*s,a.y+5*s),t.bright,2.5),e.line(i(a.x-1.5*s,a.y+5*s),i(a.x+7*s,a.y-5.5*s),t.bright,2.5)}},on:[G(()=>({kind:"check"}))]}),z=["Move","Rotate","Scale"],wn=p()("w-segment",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.rect,c=h(r.x,r.center.y-15,r.w,30);e.box(c,8,t.well,t.muted,1);const o=c.w/z.length,a=h(c.x+o*n.props.index+2,c.y+2,o-4,c.h-4);e.box(a,6,w(t.accent,.8)),z.forEach((s,l)=>e.label(s,i(c.x+o*(l+.5),c.center.y),l===n.props.index?t.bright:t.dim,{size:11,weight:600}))},on:[G(n=>{const e=n.rect,t=(n.pointer??e.center).x;return{kind:"segment",value:d(Math.floor((t-e.x)/e.w*z.length),0,z.length-1)}})]}),Y=["x","y","z"],F={x:0,y:130,z:215},fn=p()("w-vec3",{size:()=>i(g,y),style:(n,e)=>v(n,e),render:(n,e,t)=>{const r=n.props,c=n.rect,o=c.h/3;Y.forEach((a,s)=>{const l=c.y+o*(s+.5),u=c.x+22,x=c.w-30;e.label(a.toUpperCase(),i(c.x+4,l),k(F[a],.6,.6),{size:11,weight:700,align:"left"}),e.box(h(u,l-2,x,4),2,t.muted);const M=(r[a]+1)/2;e.dot(i(u+x*d(M,0,1),l),5,k(F[a],.6,.6))})},on:[C({begin(n,e){const t=n.rect,r=d(Math.floor((e.y-t.y)/(t.h/3)),0,2),c=Y[r];return{axis:c,start:n.props[c],startX:e.x}},during(n,e,t){const r=d(n.start+(t.x-n.startX)*.01,-1,1);return{kind:"vec3",value:{...e.props,[n.axis]:r}}}})]}),Cn=p()("widget-board",{measure:(n,e)=>e,hit:()=>!0,style:n=>({dot:w(n.muted,.35),hint:w(n.textDim,.9)}),render:(n,e,t)=>{const r=n.view,c=32,o=Math.floor(-r.pan.x/r.zoom/c)*c,a=(r.w-r.pan.x)/r.zoom,s=Math.floor(-r.pan.y/r.zoom/c)*c,l=(r.h-r.pan.y)/r.zoom;for(let u=o;u<=a;u+=c)for(let x=s;x<=l;x+=c)e.dot(i(u,x),1,t.dot);e.label("drag the controls · drag empty space to pan · wheel to zoom",i(120,22),t.hint,{align:"left",size:12})},on:[L()]}),Mn=212,kn=150,I=3,qn=n=>i(24+n%I*(Mn+16),44+Math.floor(n/I)*(kn+16)),b=(n,e,t,r)=>({...Z(e.toLowerCase().replace(/\s+/g,"-"),{title:e,value:t},[r]),pos:qn(n)});function zn(n){const e=[b(0,"Slider",n.scalar.toFixed(2),cn("c",{value:n.scalar})),b(1,"Range",`${n.range.min.toFixed(2)}–${n.range.max.toFixed(2)}`,on("c",{min:n.range.min,max:n.range.max})),b(2,"Number",n.scrub.toFixed(1),an("c",{value:n.scrub})),b(3,"Ease",`${n.ease.x1.toFixed(2)},${n.ease.y1.toFixed(2)},${n.ease.x2.toFixed(2)},${n.ease.y2.toFixed(2)}`,ln("c",{...n.ease})),b(4,"Angle",`${Math.round(n.angle)}°`,un("c",{angle:n.angle})),b(5,"Arc",`${Math.round(n.arc.start)}°–${Math.round(n.arc.end)}°`,hn("c",{start:n.arc.start,end:n.arc.end})),b(6,"Vector 2",`${n.xy.x.toFixed(2)}, ${n.xy.y.toFixed(2)}`,xn("c",{x:n.xy.x,y:n.xy.y})),b(7,"Bounds 2D",`${n.box.minX.toFixed(1)},${n.box.minY.toFixed(1)}→${n.box.maxX.toFixed(1)},${n.box.maxY.toFixed(1)}`,mn("c",{...n.box})),b(8,"Box 3D",`${Math.round(X(n.cube.yaw))}°`,pn("c",{yaw:n.cube.yaw,pitch:n.cube.pitch})),b(9,"Color",R(k(n.color.hue*360,n.color.sat,.55)),bn("c",{hue:n.color.hue,sat:n.color.sat})),b(10,"Gradient",R(W(V,O,n.gradient)),gn("c",{at:n.gradient})),b(11,"Toggle",n.toggle?"on":"off",yn("c",{on:n.toggle})),b(12,"Checkbox",n.check?"✓":"—",vn("c",{on:n.check})),b(13,"Mode",z[n.segment],wn("c",{index:n.segment})),b(14,"Vector 3",`${n.vec3.x.toFixed(1)},${n.vec3.y.toFixed(1)},${n.vec3.z.toFixed(1)}`,fn("c",{x:n.vec3.x,y:n.vec3.y,z:n.vec3.z}))];return Cn("root",{},[Q("cards",{},e)])}const Sn=document.getElementById("c");K(Sn,{init:{scalar:.4,range:{min:.25,max:.75},scrub:42,ease:{x1:.42,y1:0,x2:.58,y2:1},angle:45,arc:{start:20,end:200},xy:{x:.35,y:.5},box:{minX:.2,minY:.25,maxX:.75,maxY:.7},cube:{yaw:.7,pitch:.4},color:{hue:.58,sat:.7},gradient:.5,toggle:!0,check:!0,segment:0,vec3:{x:.3,y:-.2,z:.6}},update:rn,view:zn});J([{name:"main.ts",code:en},{name:"widgets.ts (shared)",code:nn}]);
