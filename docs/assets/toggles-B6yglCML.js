import{P as l,u as g,m as h,d as p,S as d,L as s,s as m,t as u,R as w}from"./source-panel-cwX9nwkb.js";import{g as c,w as k}from"./extend-D1DJsxuA.js";import{b as v}from"./effects-BGArodll.js";import{T as i,S as r,a}from"./widgets-DkU5qRHh.js";import{w as f}from"./widgets-deNE_SuD.js";const S=`// ============================================================================
...
`,b=c(l(e=>{var t;return(t=e.spawn)==null||t.call(e,v(e.pointer??e.rect.center,g.accent)),null}));function T(e,t){switch(t.kind){case"toggle-power":return{...e,power:!e.power};case"set-volume":return{...e,volume:t.value};case"set-glow":return{...e,glow:t.value};case"toggle-option":return{...e,options:{...e.options,[t.which]:!e.options[t.which]}};case"toggle-theme":return m(u==="dark"?"light":"dark"),{...e,lightTheme:!e.lightTheme}}}function o(e,t,n){return w(e,{gap:14},[s(`${e}/caption`,{text:t,dim:!0}),n])}function x(e){const t=n=>e.options.sparks?k(n,b):n;return d("root",{gap:14,pad:48},[s("title",{text:"Widgets",size:20,weight:600,bright:!0}),o("power","Power",t(i("widget",{on:e.power,flip:{kind:"toggle-power"}}))),o("volume","Volume",r("widget",{value:e.volume,set:n=>({kind:"set-volume",value:n})})),o("glow","Glow",r("widget",{value:e.glow,set:n=>({kind:"set-glow",value:n})})),o("sparks","Sparks",t(a("widget",{on:e.options.sparks,toggle:{kind:"toggle-option",which:"sparks"}}))),o("grid","Grid",t(a("widget",{on:e.options.grid,toggle:{kind:"toggle-option",which:"grid"}}))),o("theme","Light theme",t(i("widget",{on:e.lightTheme,flip:{kind:"toggle-theme"}}))),s("hint",{text:"Sparks = a press extension appended to stock widgets at their use site.",dim:!0})])}const E=document.getElementById("c");h(E,{init:{power:!0,volume:.6,glow:.25,options:{sparks:!0,grid:!1},lightTheme:!1},update:T,view:x});p([{name:"main.ts",code:S},{name:"widgets.ts (shared)",code:f}]);
