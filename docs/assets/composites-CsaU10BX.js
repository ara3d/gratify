import{m as p,d as g,S as f,L as a,R as b,s as w,f as c,g as l,t as y}from"./source-panel-cwX9nwkb.js";import{w as v,m as u}from"./extend-D1DJsxuA.js";import{C as m,L as h,S as k,a as x,B as d}from"./widgets-DkU5qRHh.js";import{w as B}from"./widgets-deNE_SuD.js";const T=`// ============================================================================
...
`,S=u((e,t,n)=>{const[r,...s]=n,o=r;return[{...o,children:[...o.children??[],a("footer",{text:"— themed footer —",dim:!0,size:10})]},...s]});function E(e,t){switch(t.kind){case"agree":return{...e,agreed:!e.agreed};case"set-volume":return{...e,volume:t.value};case"toggle-footers":{const n=!e.footers;return n?R(S):C(),{...e,footers:n}}case"toggle-theme":return w(y==="dark"?"light":"dark"),{...e,light:!e.light}}}const R=e=>{c("dark","card",e),c("light","card",e)},C=()=>{l("dark","card"),l("light","card")};function L(e){return f("root",{gap:16,pad:40},[a("title",{text:"Composites — parts made of parts",size:20,weight:600,bright:!0}),m("settings",{title:"Settings",value:"card = rung 2"},[h("vol","Volume",k("vol/s",{value:e.volume,set:t=>({kind:"set-volume",value:t})})),h("agree","Agree",x("agree/c",{on:e.agreed,toggle:{kind:"agree"}}))]),v(m("promo",{title:"One card only",value:"use-site mapBody"},[a("promo/body",{text:"A badge was appended below by withExt(…, mapBody).",dim:!0,size:11})]),u((t,n,r)=>{const[s,...o]=r,i=s;return[{...i,children:[...i.children??[],d("promo/badge",{label:"Injected button",press:{kind:"agree"}})]},...o]})),b("controls",{gap:14},[d("footers",{label:e.footers?"Remove card footers":"Add card footers (theme scope)",press:{kind:"toggle-footers"}}),d("theme",{label:"Toggle theme",press:{kind:"toggle-theme"}})]),a("hint",{text:"Footers = a theme-scope mapBody on the card part; it reaches BOTH cards at once.",dim:!0})])}const A=document.getElementById("c");p(A,{init:{agreed:!1,volume:.5,footers:!1,light:!1},update:E,view:L});g([{name:"main.ts",code:T},{name:"widgets.ts (shared)",code:B}]);
