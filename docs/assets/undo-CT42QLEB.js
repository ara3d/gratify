import{p as u,m as h,d as l,S as c,L as d,R as a,h as s,v as p}from"./source-panel-CwjQB28X.js";import{w as m}from"./middleware-DyZMnhdR.js";import{B as o}from"./widgets-CaJ4_Cu6.js";const f=`// ============================================================================
...
`;function b(e,n){switch(n.kind){case"add":{const t={id:`dot-${e.nextIdNumber}`,hue:e.nextIdNumber*47%360};return{nextIdNumber:e.nextIdNumber+1,dots:[...e.dots,t]}}case"remove-last":return{...e,dots:e.dots.slice(0,-1)};case"shuffle":return{...e,dots:e.dots.map(t=>({...t,hue:(t.hue+120)%360}))}}}const w=u("color-dot",{size:()=>p(26,26),channels:{hue:{target:e=>e.props.hue,rate:8}},render(e,n){const t=e.ch.hue,r=6+6*e.ch.hover,i=11+2*e.ch.hover;n.glow(s(t,.8,.6),r,()=>n.dot(e.rect.center,i,s(t,.8,.62)))}});function g(e){return c("root",{gap:16,pad:48},[d("title",{text:"Undoable dots",size:20,weight:600,bright:!0}),a("toolbar",{gap:8},[o("add",{label:"+ Dot",press:{kind:"add"},accent:!0}),o("remove",{label:"Remove",press:{kind:"remove-last"},danger:!0}),o("shuffle",{label:"Shuffle hues",press:{kind:"shuffle"}})]),a("dots",{gap:8},e.dots.map(n=>w(n.id,{hue:n.hue}))),a("history",{gap:8},[o("undo",{label:"⟲ Undo",press:{kind:"undo"}}),o("redo",{label:"⟳ Redo",press:{kind:"redo"}})]),d("hint",{text:"Delete a dot, then undo — it pops back in through its enter animation.",dim:!0})])}const k=document.getElementById("c");h(k,m({init:{dots:[{id:"dot-a",hue:10},{id:"dot-b",hue:130},{id:"dot-c",hue:250}],nextIdNumber:0},update:b,view:g}));l([{name:"main.ts",code:f}]);
