import{p as h,D as T,r as u,v as i,G as f,c as M,h as k,b as $,P as D,i as d,l as L,m as K,d as J,x as _,k as Q,j as I}from"./source-panel-CIMbntSC.js";import{C as Z}from"./widgets-BKG2T7ka.js";import{w as nn}from"./widgets-deNE_SuD.js";const en=`// ============================================================================
...
`,p=184,b=92;function v(n){const e=Math.min(n.w,n.h);return u(n.center.x-e/2,n.center.y-e/2,e,e)}const g=(n,e)=>({muted:n.muted,accent:n.accent,bright:n.textBright,dim:n.textDim,well:M(n.bg,.5),thumb:n.mix(n.textBright,n.accent,.3*(e.hover||0)),glow:9*(e.hover||0)});function tn(n,e,t,r,c){const o=e.center.y;n.box(u(e.x,o-2.5,e.w,5),2.5,r),t>0&&n.box(u(e.x,o-2.5,e.w*d(t,0,1),5),2.5,c)}function w(n,e,t,r,c,o){n.glow(c,r,()=>n.dot(e,t,o))}const A=Math.PI*2,X=n=>(n*180/Math.PI+360)%360;function rn(n,e){switch(e.kind){case"scalar":return{...n,scalar:e.value};case"range":return{...n,range:e.value};case"scrub":return{...n,scrub:e.value};case"knob":return{...n,knob:e.value};case"angle":return{...n,angle:e.value};case"arc":return{...n,arc:e.value};case"xy":return{...n,xy:e.value};case"box":return{...n,box:e.value};case"cube":return{...n,cube:e.value};case"color":return{...n,color:e.value};case"gradient":return{...n,gradient:e.value};case"toggle":return{...n,toggle:!n.toggle};case"check":return{...n,check:!n.check};case"segment":return{...n,segment:e.value};case"vec3":return{...n,vec3:e.value}}}const cn=h()("w-slider",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.rect,c=u(r.x+8,r.center.y-10,r.w-16,20);tn(e,c,n.props.value,t.muted,t.accent),w(e,i(c.x+c.w*n.props.value,c.center.y),7+1.5*n.ch.hover,t.glow,t.accent,t.thumb)},on:[T({axis:"x",pad:8,to:(n,e)=>({kind:"scalar",value:e})})]}),on=h()("w-range",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.props,c=n.rect,o=u(c.x+8,c.y,c.w-16,c.h),a=o.center.y;e.box(u(o.x,a-2.5,o.w,5),2.5,t.muted);const s=o.x+o.w*r.min,l=o.x+o.w*r.max;e.box(u(s,a-2.5,l-s,5),2.5,t.accent),w(e,i(s,a),7,t.glow,t.accent,t.thumb),w(e,i(l,a),7,t.glow,t.accent,t.thumb)},on:[f({begin(n,e){const t=u(n.rect.x+8,n.rect.y,n.rect.w-16,n.rect.h),r=d((e.x-t.x)/t.w,0,1);return{which:Math.abs(r-n.props.min)<=Math.abs(r-n.props.max)?"min":"max"}},during(n,e,t){const r=u(e.rect.x+8,e.rect.y,e.rect.w-16,e.rect.h),c=d((t.x-r.x)/r.w,0,1),{min:o,max:a}=e.props;return{kind:"range",value:n.which==="min"?{min:Math.min(c,a),max:a}:{min:o,max:Math.max(c,o)}}}})]}),an=h()("w-scrub",{size:()=>i(p,b),style:(n,e)=>({...g(n,e),text:n.mix(n.text,n.textBright,e.hover||0)}),render:(n,e,t)=>{const r=n.rect;e.label(n.props.value.toFixed(1),r.center,t.text,{size:26,weight:700}),e.label("‹ drag horizontally ›",i(r.center.x,r.bottom-6),M(t.dim,.8),{size:10})},on:[f({begin:(n,e)=>({start:n.props.value,startX:e.x}),during:(n,e,t)=>({kind:"scrub",value:n.start+(t.x-n.startX)*.5})})]}),sn=h()("w-knob",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=v(n.rect),c=r.center,o=r.w/2-6;e.ring(c,o,t.muted,3);const a=(.75+n.props.value*1.5)*Math.PI,s=i(c.x+Math.cos(a)*o,c.y+Math.sin(a)*o);e.line(c,s,t.accent,3),w(e,s,5+n.ch.hover*2,t.glow,t.accent,t.thumb),e.dot(c,3,t.dim)},on:[f({begin:(n,e)=>({start:n.props.value,startY:e.y}),during:(n,e,t)=>({kind:"knob",value:d(n.start-(t.y-n.startY)*.006,0,1)})})]}),ln=h()("w-angle",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=v(n.rect),c=r.center,o=r.w/2-6;e.ring(c,o,t.muted,2);const a=n.props.angle*Math.PI/180,s=i(c.x+Math.cos(a)*o,c.y+Math.sin(a)*o);e.line(c,s,t.accent,2.5),w(e,s,5+n.ch.hover*2,t.glow,t.accent,t.thumb),e.dot(c,3,t.dim)},on:[f({begin:()=>({}),during(n,e,t){const r=v(e.rect).center;return{kind:"angle",value:X(Math.atan2(t.y-r.y,t.x-r.x))}}})]});function un(n,e,t,r,c,o){const a=(c-r+360)%360||360,s=Math.max(2,Math.round(a/8));for(let l=0;l<=s;l++){const m=(r+a*l/s)*Math.PI/180;n.dot(i(e.x+Math.cos(m)*t,e.y+Math.sin(m)*t),2,o)}}const dn=h()("w-arc",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.props,c=v(n.rect),o=c.center,a=c.w/2-6;e.ring(o,a,t.muted,1.5),un(e,o,a,r.start,r.end,t.accent);for(const s of[r.start,r.end]){const l=s*Math.PI/180;w(e,i(o.x+Math.cos(l)*a,o.y+Math.sin(l)*a),5+n.ch.hover*2,t.glow,t.accent,t.thumb)}},on:[f({begin(n,e){const t=v(n.rect).center,r=X(Math.atan2(e.y-t.y,e.x-t.x)),c=o=>Math.min((r-o+360)%360,(o-r+360)%360);return{which:c(n.props.start)<=c(n.props.end)?"start":"end"}},during(n,e,t){const r=v(e.rect).center,c=X(Math.atan2(t.y-r.y,t.x-r.x));return{kind:"arc",value:{...e.props,[n.which]:c}}}})]}),mn=h()("w-xy",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.props,c=v(n.rect);e.box(c,6,t.well,t.muted,1),e.line(i(c.x,c.center.y),i(c.right,c.center.y),M(t.muted,.6)),e.line(i(c.center.x,c.y),i(c.center.x,c.bottom),M(t.muted,.6));const o=i(c.center.x+r.x*c.w/2,c.center.y-r.y*c.h/2);w(e,o,6+n.ch.hover*2,t.glow,t.accent,t.thumb)},on:[f({begin:()=>({}),during(n,e,t){const r=v(e.rect);return{kind:"xy",value:{x:d((t.x-r.center.x)/(r.w/2),-1,1),y:d(-(t.y-r.center.y)/(r.h/2),-1,1)}}}})]}),hn=h()("w-box2d",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.props,c=v(n.rect);e.box(c,6,t.well,t.muted,1);const o=(l,m)=>i(c.x+l*c.w,c.bottom-m*c.h),a=o(r.minX,r.minY),s=o(r.maxX,r.maxY);e.box(u(Math.min(a.x,s.x),Math.min(a.y,s.y),Math.abs(s.x-a.x),Math.abs(s.y-a.y)),3,M(t.accent,.2),t.accent,1.5),w(e,a,5+n.ch.hover,t.glow,t.accent,t.thumb),w(e,s,5+n.ch.hover,t.glow,t.accent,t.thumb)},on:[f({begin(n,e){const t=v(n.rect),r=n.props,c=(s,l)=>i(t.x+s*t.w,t.bottom-l*t.h),o=I(e,c(r.minX,r.minY)),a=I(e,c(r.maxX,r.maxY));return{corner:o<=a?"min":"max"}},during(n,e,t){const r=v(e.rect),c=d((t.x-r.x)/r.w,0,1),o=d((r.bottom-t.y)/r.h,0,1),a=e.props,s=n.corner==="min"?{...a,minX:Math.min(c,a.maxX),minY:Math.min(o,a.maxY)}:{...a,maxX:Math.max(c,a.minX),maxY:Math.max(o,a.minY)};return{kind:"box",value:{minX:s.minX,minY:s.minY,maxX:s.maxX,maxY:s.maxY}}}})]}),F=[];for(let n=0;n<8;n++)F.push([n&1?1:-1,n&2?1:-1,n&4?1:-1]);const H=[];for(let n=0;n<8;n++)for(let e=n+1;e<8;e++){const t=n^e;(t===1||t===2||t===4)&&H.push([n,e])}const xn=h()("w-box3d",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const{yaw:r,pitch:c}=n.props,o=v(n.rect),a=o.center,s=o.w/2-8,l=Math.cos(r),m=Math.sin(r),y=Math.cos(c),C=Math.sin(c),N=([z,S,G])=>{const U=z*l+G*m,Y=-z*m+G*l,j=S*y-Y*C,P=1/(1+(S*C+Y*y)*.18);return i(a.x+U*s*P,a.y+j*s*P)},E=F.map(N);for(const[z,S]of H)e.line(E[z],E[S],M(t.accent,.85),1.5);for(const z of E)e.dot(z,2.5,t.bright)},on:[f({begin:(n,e)=>({yaw:n.props.yaw,pitch:n.props.pitch,x:e.x,y:e.y}),during:(n,e,t)=>({kind:"cube",value:{yaw:n.yaw+(t.x-n.x)*.012,pitch:d(n.pitch+(t.y-n.y)*.012,-1.3,1.3)}})})]}),pn=h()("w-color",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const{hue:r,sat:c}=n.props,o=v(n.rect),a=o.center,s=o.w/2-4;for(let y=0;y<72;y++){const C=y/72*A;e.dot(i(a.x+Math.cos(C)*s,a.y+Math.sin(C)*s),3,k(y/72*360,.7,.55))}e.dot(a,s-8,k(r*360,c,.55));const l=r*A,m=c*(s-8);w(e,i(a.x+Math.cos(l)*m,a.y+Math.sin(l)*m),5+n.ch.hover*2,t.glow,t.accent,t.thumb)},on:[f({begin:()=>({}),during(n,e,t){const r=v(e.rect),c=r.center,o=r.w/2-12,a=t.x-c.x,s=t.y-c.y;return{kind:"color",value:{hue:(Math.atan2(s,a)/A%1+1)%1,sat:d(Math.hypot(a,s)/o,0,1)}}}})]}),O=k(205,.75,.55),V=k(330,.75,.58),bn=h()("w-gradient",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.props.at,c=n.rect,o=u(c.x+8,c.center.y-14,c.w-16,28),a=48;for(let l=0;l<a;l++)e.box(u(o.x+o.w*l/a,o.y,o.w/a+1,o.h),0,$(O,V,l/a));const s=o.x+o.w*r;e.box(u(s-2,o.y-4,4,o.h+8),1,t.bright),w(e,i(s,o.bottom+8),5+n.ch.hover,t.glow,t.accent,t.thumb)},on:[T({axis:"x",pad:8,to:(n,e)=>({kind:"gradient",value:e})})]}),gn=h()("w-toggle",{size:()=>i(p,b),channels:{on:{target:n=>n.props.on?1:0,spring:{stiffness:260,damping:20}}},style:(n,e)=>({...g(n,e),track:n.mix(n.muted,n.accent,d(e.on||0,0,1))}),render:(n,e,t)=>{const r=n.rect,c=d(n.ch.on,0,1),o=u(r.center.x-26,r.center.y-13,52,26);e.box(o,13,t.track),e.glow(t.accent,8*n.ch.hover,()=>e.dot(i(o.x+13+c*26,o.center.y),9,t.bright))},on:[D(()=>({kind:"toggle"}))]}),yn=h()("w-check",{size:()=>i(p,b),channels:{on:{target:n=>n.props.on?1:0,spring:{stiffness:340,damping:22}}},style:(n,e)=>{const t=d(e.on||0,0,1);return{...g(n,e),fill:n.mix(n.surface,n.accent,t*.9),edge:n.mix(n.muted,n.accent,Math.max(t,e.hover||0))}},render:(n,e,t)=>{const r=n.rect,c=d(n.ch.on,0,1),o=u(r.center.x-15,r.center.y-15,30,30);if(e.box(o,7,t.fill,t.edge,1.5),c>.02){const a=o.center,s=Math.min(1.1,c);e.line(i(a.x-6*s,a.y),i(a.x-1.5*s,a.y+5*s),t.bright,2.5),e.line(i(a.x-1.5*s,a.y+5*s),i(a.x+7*s,a.y-5.5*s),t.bright,2.5)}},on:[D(()=>({kind:"check"}))]}),q=["Move","Rotate","Scale"],vn=h()("w-segment",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.rect,c=u(r.x,r.center.y-15,r.w,30);e.box(c,8,t.well,t.muted,1);const o=c.w/q.length,a=u(c.x+o*n.props.index+2,c.y+2,o-4,c.h-4);e.box(a,6,M(t.accent,.8)),q.forEach((s,l)=>e.label(s,i(c.x+o*(l+.5),c.center.y),l===n.props.index?t.bright:t.dim,{size:11,weight:600}))},on:[D(n=>{const e=n.rect,t=(n.pointer??e.center).x;return{kind:"segment",value:d(Math.floor((t-e.x)/e.w*q.length),0,q.length-1)}})]}),B=["x","y","z"],R={x:0,y:130,z:215},wn=h()("w-vec3",{size:()=>i(p,b),style:(n,e)=>g(n,e),render:(n,e,t)=>{const r=n.props,c=n.rect,o=c.h/3;B.forEach((a,s)=>{const l=c.y+o*(s+.5),m=c.x+22,y=c.w-30;e.label(a.toUpperCase(),i(c.x+4,l),k(R[a],.6,.6),{size:11,weight:700,align:"left"}),e.box(u(m,l-2,y,4),2,t.muted);const C=(r[a]+1)/2;e.dot(i(m+y*d(C,0,1),l),5,k(R[a],.6,.6))})},on:[f({begin(n,e){const t=n.rect,r=d(Math.floor((e.y-t.y)/(t.h/3)),0,2),c=B[r];return{axis:c,start:n.props[c],startX:e.x}},during(n,e,t){const r=d(n.start+(t.x-n.startX)*.01,-1,1);return{kind:"vec3",value:{...e.props,[n.axis]:r}}}})]}),fn=h()("widget-board",{size:()=>i(0,0),hit:()=>!0,style:n=>({dot:M(n.muted,.35),hint:M(n.textDim,.9)}),render:(n,e,t)=>{const r=n.view,c=32,o=Math.floor(-r.pan.x/r.zoom/c)*c,a=(r.w-r.pan.x)/r.zoom,s=Math.floor(-r.pan.y/r.zoom/c)*c,l=(r.h-r.pan.y)/r.zoom;for(let m=o;m<=a;m+=c)for(let y=s;y<=l;y+=c)e.dot(i(m,y),1,t.dot);e.label("drag the controls · drag empty space to pan · wheel to zoom",i(120,22),t.hint,{align:"left",size:12})},on:[L()]}),Mn=212,Cn=150,W=3,kn=n=>i(24+n%W*(Mn+16),44+Math.floor(n/W)*(Cn+16)),x=(n,e,t,r)=>({...Z(e.toLowerCase().replace(/\s+/g,"-"),{title:e,value:t},[r]),pos:kn(n)});function zn(n){const e=[x(0,"Slider",n.scalar.toFixed(2),cn("c",{value:n.scalar})),x(1,"Range",`${n.range.min.toFixed(2)}–${n.range.max.toFixed(2)}`,on("c",{min:n.range.min,max:n.range.max})),x(2,"Number",n.scrub.toFixed(1),an("c",{value:n.scrub})),x(3,"Knob",`${Math.round(n.knob*100)}%`,sn("c",{value:n.knob})),x(4,"Angle",`${Math.round(n.angle)}°`,ln("c",{angle:n.angle})),x(5,"Arc",`${Math.round(n.arc.start)}°–${Math.round(n.arc.end)}°`,dn("c",{start:n.arc.start,end:n.arc.end})),x(6,"Vector 2",`${n.xy.x.toFixed(2)}, ${n.xy.y.toFixed(2)}`,mn("c",{x:n.xy.x,y:n.xy.y})),x(7,"Bounds 2D",`${n.box.minX.toFixed(1)},${n.box.minY.toFixed(1)}→${n.box.maxX.toFixed(1)},${n.box.maxY.toFixed(1)}`,hn("c",{...n.box})),x(8,"Box 3D",`${Math.round(X(n.cube.yaw))}°`,xn("c",{yaw:n.cube.yaw,pitch:n.cube.pitch})),x(9,"Color",_(k(n.color.hue*360,n.color.sat,.55)),pn("c",{hue:n.color.hue,sat:n.color.sat})),x(10,"Gradient",_($(O,V,n.gradient)),bn("c",{at:n.gradient})),x(11,"Toggle",n.toggle?"on":"off",gn("c",{on:n.toggle})),x(12,"Checkbox",n.check?"✓":"—",yn("c",{on:n.check})),x(13,"Mode",q[n.segment],vn("c",{index:n.segment})),x(14,"Vector 3",`${n.vec3.x.toFixed(1)},${n.vec3.y.toFixed(1)},${n.vec3.z.toFixed(1)}`,wn("c",{x:n.vec3.x,y:n.vec3.y,z:n.vec3.z}))];return fn("root",{},[Q("cards",{},e)])}const qn=document.getElementById("c");K(qn,{init:{scalar:.4,range:{min:.25,max:.75},scrub:42,knob:.6,angle:45,arc:{start:20,end:200},xy:{x:.35,y:.5},box:{minX:.2,minY:.25,maxX:.75,maxY:.7},cube:{yaw:.7,pitch:.4},color:{hue:.58,sat:.7},gradient:.5,toggle:!0,check:!0,segment:0,vec3:{x:.3,y:-.2,z:.6}},update:rn,view:zn});J([{name:"main.ts",code:en},{name:"widgets.ts (shared)",code:nn}]);
