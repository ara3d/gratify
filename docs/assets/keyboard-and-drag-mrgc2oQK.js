import{p as l,m as u,d as m,S as h,L as p,i as g,F as f,K as x,G as w,v as i,h as b,c as v}from"./source-panel-CIMbntSC.js";const y=`// ============================================================================
...
`,s=38,a=8,R=s+a;function I(e,n){const t=e.items.findIndex(c=>c.id===n.id),o=g(n.index,0,e.items.length-1);if(t<0||t===o)return e;const r=[...e.items],[d]=r.splice(t,1);return r.splice(o,0,d),{items:r}}const k=l("reorderable-row",{size:()=>i(260,s),style(e,n){return{fill:e.mix(e.surface,e.surfaceHi,n.hover+n.drag),edge:e.mix(e.muted,e.accent,Math.max(n.focus,n.drag)),text:e.mix(e.text,e.textBright,n.hover),focusRing:n.focus,lift:3*n.drag}},render(e,n,t){const o=e.rect.raise(t.lift);n.box(o,9,t.fill,t.edge,1+t.focusRing),n.dot(i(o.x+20,o.center.y),6,b(e.props.hue,.75,.6)),n.label(e.props.label,i(o.x+36,o.center.y),t.text,{align:"left"}),t.focusRing>.02&&n.label("↕",i(o.right-16,o.center.y),v(t.edge,t.focusRing),{size:12})},on:[f(),x({ArrowUp:e=>({kind:"move-to-index",id:e.props.id,index:e.props.index-1}),ArrowDown:e=>({kind:"move-to-index",id:e.props.id,index:e.props.index+1})}),w({begin:(e,n)=>({startPointerY:n.y,startIndex:e.props.index}),during(e,n,t){const o=Math.round((t.y-e.startPointerY)/R),r=e.startIndex+o;if(r!==n.props.index)return{kind:"move-to-index",id:n.props.id,index:r}}})]});function P(e){return h("root",{gap:a,pad:48},[p("title",{text:"Reorder: click to focus, arrows or drag to move",size:16,weight:600,bright:!0}),...e.items.map((n,t)=>k(n.id,{id:n.id,label:n.label,hue:n.hue,index:t}))])}const S=document.getElementById("c");u(S,{init:{items:[{id:"item-a",label:"Springs",hue:200},{id:"item-b",label:"Channels",hue:260},{id:"item-c",label:"Reconcile",hue:140},{id:"item-d",label:"Interactors",hue:30},{id:"item-e",label:"Extensions",hue:330}]},update:I,view:P});m([{name:"main.ts",code:y}]);
