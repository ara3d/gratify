import{c as l,r as d,p as x,P as f,v as r,m as k,a as v,b as h,S as y,L as b}from"./source-panel-D2qVZYc0.js";const T=`// ============================================================================
...
`,g=l(d(255,255,255),.55),m=l(d(0,0,0),.5),a=d(0,0,0,0);function w(n,e,t,o,i){switch(t){case"none":return;case"single":n.box(e,0,a,o,1);return;case"double":n.box(e,0,a,o,1),n.box(e.inset(3),0,a,o,1);return;case"raised":case"sunken":{const c=Math.max(t==="sunken"?1:0,i),p=h(g,m,c),u=h(m,g,c);n.line(r(e.x,e.y+1),r(e.right,e.y+1),p,2),n.line(r(e.x+1,e.y),r(e.x+1,e.bottom),p,2),n.line(r(e.x,e.bottom-1),r(e.right,e.bottom-1),u,2),n.line(r(e.right-1,e.y),r(e.right-1,e.bottom),u,2);return}}}const P=x("panel",{size:()=>r(220,58),style(n,e){const t=n.mix(n.textDim,n.textBright,.4+.6*e.hover);return{fill:n.mix(n.surface,n.surfaceHi,.5+.4*e.hover),outline:n.mix(n.muted,n.text,.3+.4*e.hover),kindText:t,subText:l(t,.7),pressFlip:e.press}},render(n,e,t){const o=n.rect,i=n.props.border==="sunken"||n.props.border==="raised";e.box(o,i?0:6,t.fill),w(e,o,n.props.border,t.outline,t.pressFlip);const s=1.5*t.pressFlip;e.label(n.props.border,r(o.x+18+s,o.center.y+s),t.kindText,{weight:600,align:"left"}),e.label(n.props.label,r(o.right-18+s,o.center.y+s),t.subText,{size:11,align:"right"})},on:[f(()=>({kind:"noop"}))]}),S=(n,e)=>n,E=["none","single","double","sunken","raised"];function B(n){return y("root",{gap:12,pad:40},[b("title",{text:"Border styles",size:20,weight:600,bright:!0}),b("subtitle",{text:"Press the raised & sunken panels — the bevel flips.",dim:!0}),...E.map(e=>P(e,{label:"click me",border:e}))])}const D=document.getElementById("c");k(D,{init:{},update:S,view:B});v([{name:"main.ts",code:T}]);
