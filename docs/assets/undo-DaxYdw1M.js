import{p as i,h as s,v as h,m as c,a as l,S as p,L as u,R as d}from"./source-panel-CJOI54oU.js";import{B as a}from"./widgets-D6-7td_P.js";const m=n=>{const t=n==null?void 0:n.kind;return t==="undo"||t==="redo"};function f(n,t=200){return{init:{past:[],present:n.init,future:[]},update(e,o){if(m(o))return o.kind==="undo"&&e.past.length?{past:e.past.slice(0,-1),present:e.past[e.past.length-1],future:[e.present,...e.future]}:o.kind==="redo"&&e.future.length?{past:[...e.past,e.present],present:e.future[0],future:e.future.slice(1)}:e;const r=n.update(e.present,o);return r===e.present?e:{past:[...e.past,e.present].slice(-t),present:r,future:[]}},view:e=>n.view(e.present)}}const b=`// ============================================================================
...
`;function w(n,t){switch(t.kind){case"add":{const e={id:`dot-${n.nextIdNumber}`,hue:n.nextIdNumber*47%360};return{nextIdNumber:n.nextIdNumber+1,dots:[...n.dots,e]}}case"remove-last":return{...n,dots:n.dots.slice(0,-1)};case"shuffle":return{...n,dots:n.dots.map(e=>({...e,hue:(e.hue+120)%360}))}}}const g=i("color-dot",{size:()=>h(26,26),channels:{hue:{target:n=>n.props.hue,rate:8}},render(n,t){const e=n.ch.hue,o=6+6*n.ch.hover,r=11+2*n.ch.hover;t.glow(s(e,.8,.6),o,()=>t.dot(n.rect.center,r,s(e,.8,.62)))}});function k(n){return p("root",{gap:16,pad:48},[u("title",{text:"Undoable dots",size:20,weight:600,bright:!0}),d("toolbar",{gap:8},[a("add",{label:"+ Dot",press:{kind:"add"},accent:!0}),a("remove",{label:"Remove",press:{kind:"remove-last"},danger:!0}),a("shuffle",{label:"Shuffle hues",press:{kind:"shuffle"}})]),d("dots",{gap:8},n.dots.map(t=>g(t.id,{hue:t.hue}))),d("history",{gap:8},[a("undo",{label:"⟲ Undo",press:{kind:"undo"}}),a("redo",{label:"⟳ Redo",press:{kind:"redo"}})]),u("hint",{text:"Delete a dot, then undo — it pops back in through its enter animation.",dim:!0})])}const v=document.getElementById("c");c(v,f({init:{dots:[{id:"dot-a",hue:10},{id:"dot-b",hue:130},{id:"dot-c",hue:250}],nextIdNumber:0},update:w,view:k}));l([{name:"main.ts",code:b}]);
