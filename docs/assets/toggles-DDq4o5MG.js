import{P as m,B as w,m as f,S as v,L as d,s as S,t as b,c as x,v as T,R as y}from"./runtime-DNEt0yeT.js";import{h as u,w as l,T as p,S as h,C as c,m as E}from"./widgets-BUxxEPAc.js";import{b as G}from"./effects-BhoHrEqA.js";import{a as P}from"./source-panel-CSqvtNlY.js";import{w as R}from"./widgets-EtuMVc6k.js";const L=`// ============================================================================\r
...
`,O=u(m(e=>{var t;return(t=e.spawn)==null||t.call(e,G(e.pointer??e.rect.center,w.accent)),null})),B=E((e,t,n,s)=>{const o=e.ch.grid??0;if(o>.01){const i=e.rect,k=x(w.muted,.35*Math.min(1,o));for(let a=i.x+28/2;a<i.right;a+=28)for(let g=i.y+28/2;g<i.bottom;g+=28)t.dot(T(a,g),1,k)}s()});function D(e,t){switch(t.kind){case"toggle-power":return{...e,power:!e.power};case"set-volume":return{...e,volume:t.value};case"set-glow":return{...e,glow:t.value};case"toggle-option":return{...e,options:{...e.options,[t.which]:!e.options[t.which]}};case"toggle-theme":return S(b==="dark"?"light":"dark"),{...e,lightTheme:!e.lightTheme}}}function r(e,t,n,s){const o=d(`${e}/caption`,{text:t,dim:!0});return y(e,{gap:14},[s===void 0?o:l(o,u(m(()=>s))),n])}function I(e){const t=n=>e.options.sparks?l(n,O):n;return l(v("root",{gap:14,pad:48,states:{grid:e.options.grid}},[d("title",{text:"Widgets",size:20,weight:600,bright:!0}),r("power","Power",t(p("widget",{on:e.power,flip:{kind:"toggle-power"}})),{kind:"toggle-power"}),r("volume","Volume",h("widget",{value:e.volume,set:n=>({kind:"set-volume",value:n})})),r("glow","Glow",h("widget",{value:e.glow,set:n=>({kind:"set-glow",value:n})})),r("sparks","Sparks",t(c("widget",{on:e.options.sparks,toggle:{kind:"toggle-option",which:"sparks"}})),{kind:"toggle-option",which:"sparks"}),r("grid","Grid",t(c("widget",{on:e.options.grid,toggle:{kind:"toggle-option",which:"grid"}})),{kind:"toggle-option",which:"grid"}),r("theme","Light theme",t(p("widget",{on:e.lightTheme,flip:{kind:"toggle-theme"}})),{kind:"toggle-theme"}),d("hint",{text:"Sparks = a press extension appended to stock widgets · Grid = a render extension wrapped on the root.",dim:!0})]),B)}const N=document.getElementById("c");f(N,{init:{power:!0,volume:.6,glow:.25,options:{sparks:!0,grid:!1},lightTheme:!1},update:D,view:I});P([{name:"main.ts",code:L},{name:"widgets.ts (shared)",code:R}]);
