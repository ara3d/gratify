import{m as u,d as m,S as k,L as o,R as r,f as g,g as f,a as l,r as x,c as b}from"./source-panel-cwX9nwkb.js";import{d as y,B as s,w as d,T as w,C as v,b as S,c as h,e as E,f as C,g as A}from"./widgets-Bo9jPsTR.js";import{w as T}from"./widgets-L_2qlmzG.js";const B=`// ============================================================================
...
`,N=h((e,n,t,a)=>{a(),n.box(e.rect,8,l(0,0,0,0),l(255,92,108,.9),1.5)}),P=e=>{const n=A({"fx/sheen":{target:t=>t.ch.hover||0,rate:6}})(e);return h((t,a,O,p)=>{p();const i=t.ch["fx/sheen"]||0;if(i>.02){const c=t.rect;a.box(x(c.x,c.y,c.w*i,3),1.5,b(l(255,255,255),.35*i))}})(n)},R=E((e,n,t)=>({x:t.x+16,y:Math.max(t.y,44)})),_=C((e,n,t,a)=>({...a,fill:e.mix(a.fill,e.accent2,.35+.3*n.hover),edge:e.mix(e.accent2,e.textBright,n.hover*.5),text:e.textBright})),I=["button","checkbox","card"],z=y("fancy-button",s,P);function F(e,n){switch(n.kind){case"clicked":return{...e,clickCount:e.clickCount+1};case"toggle-neon":{const t=!e.neonActive;for(const a of I)t?g("dark",a,_):f("dark",a);return{...e,neonActive:t}}}}function L(e){return k("root",{gap:16,pad:48},[o("title",{text:"Wrap, don't edit",size:20,weight:600,bright:!0}),o("subtitle",{text:`Clicks: ${e.clickCount}`,dim:!0}),r("buttons",{gap:8},[s("stock",{label:"Stock",press:{kind:"clicked"}}),z("fancy",{label:"Fancy (baked sheen)",press:{kind:"clicked"}}),d(s("outlined-one",{label:"Outlined (this one only)",press:{kind:"clicked"}}),N),d(s("chunky-one",{label:"Chunky",press:{kind:"clicked"}}),R)]),r("theme-row",{gap:14},[o("theme-caption",{text:"Neon (theme scope — one restyle, three part kinds)",dim:!0}),w("neon-toggle",{on:e.neonActive,flip:{kind:"toggle-neon"}})]),v("neon-card",{title:"Card",value:"surface"},[r("card-row",{gap:10},[S("cb",{on:e.neonActive,label:"same protocol",toggle:{kind:"toggle-neon"}})])]),o("hint",{text:"Hover the fancy button — its sheen channel is an appended facet.",dim:!0})])}const D=document.getElementById("c");u(D,{init:{clickCount:0,neonActive:!1},update:F,view:L});m([{name:"main.ts",code:B},{name:"widgets.ts (shared)",code:T}]);
