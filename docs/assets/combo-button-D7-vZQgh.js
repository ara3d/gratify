import{p as w,P as g,h,v as u,r as f,c as C,b as y,m as O,d as M,S as T,L as l}from"./source-panel-1CdPGxVg.js";import{b as x,R as S}from"./effects-BLXO7xpg.js";const v=`// ============================================================================
...
`,B=.6;function N(n,t){const o=t.time-n.lastClickTime<B?n.combo+1:1;return{clicks:n.clicks+1,combo:o,best:Math.max(n.best,o),lastClickTime:t.time}}function P(n){return n>=20?"UNSTOPPABLE!":n>=12?"ON FIRE":n>=7?"COMBO!":n>=3?"Nice!":""}const A=12,E=w("combo-button",{size:()=>u(220,80),channels:{heat:{target:n=>{const t=(n.time??0)-n.props.lastClickTime,e=Math.max(0,1-t/1.5);return Math.min(1,n.props.combo/A)*e},rate:6},punch:{decay:7}},style(n,t){const e=t.heat,c=n.mix(n.accent,n.danger,e);return{fill:n.mix(n.surfaceHi,c,.35+.55*e+.2*t.press),edge:n.mix(n.muted,c,Math.max(t.hover,e)),glow:c,glowAmount:6+46*e+26*t.punch,heat:e,pop:t.punch}},render(n,t,e){const c=n.time??0,o=e.heat,a=(1.5+9*o)*(.35+e.pop),m=Math.sin(c*43)*a,i=Math.cos(c*37)*a,s=n.rect,r=u(s.center.x+m,s.center.y+i),b=f(r.x-s.w/2,r.y-s.h/2,s.w,s.h),p=c*90%360,k=o>.5?C(h(p,.9,.6),o):e.edge,d=1+.16*e.pop+.05*o;t.push(),t.scaleAt(r.x,r.y,d),t.glow(e.glow,e.glowAmount,()=>t.box(b,14,e.fill,k,2+2*o)),t.label("CLICK ME!",r,y(255,255,255),{weight:700,size:20}),t.pop()},on:[g(n=>{var o,a,m;const t=n.props.combo+1;(o=n.kick)==null||o.call(n,"punch",1);const e=n.pointer??n.rect.center,c=1+Math.min(4,Math.floor(t/3));for(let i=0;i<c;i++){const s=(t*40+i*60)%360;(a=n.spawn)==null||a.call(n,x(e,h(s,.85,.6)))}return(m=n.spawn)==null||m.call(n,new S(e,h(t*40%360,.9,.62),30+t*3,.5)),{kind:"click",time:n.time??0}})]});function H(n){const t=P(n.combo);return T("root",{gap:18,pad:56,align:"center"},[l("title",{text:"Click fast!",size:22,weight:700,bright:!0}),l("combo",{text:n.combo>1?`COMBO ×${n.combo}`:" ",size:18,weight:700,bright:n.combo>1}),l("rank",{text:t||" ",size:15,weight:600,dim:!0}),E("button",{combo:n.combo,lastClickTime:n.lastClickTime}),l("stats",{text:`clicks ${n.clicks}   ·   best combo ×${n.best}`,size:12,dim:!0})])}const I=document.getElementById("c");O(I,{init:{clicks:0,combo:0,best:0,lastClickTime:-999},update:N,view:H,ambient:(n,t)=>t-n.lastClickTime<2.5});M([{name:"main.ts",code:v}]);
